...
public class PreProcessingHandler {
    ...
    public PreProcessingHandler(CSVReader csvReader)
    {
    ...
    public void makeGroups(String groups[][])
    {
        ...
        for(int i=0; i<groups.length; i++)
        {
            ...
            File groupFile = new File("Group" + count + ".txt");
            try
            {
    ...
    public void doTagFile()
    {
        ...
        try {
            ...
            {
                System.out.print(shortReadList.get(i).getCount() + "\t\t" + shortReadList.get(i).getRegion() + "\n");
                f0.write(shortReadList.get(i).getCount() + "\t\t" + shortReadList.get(i).getRegion() + "\n");
            }
            f0.close();
        }
