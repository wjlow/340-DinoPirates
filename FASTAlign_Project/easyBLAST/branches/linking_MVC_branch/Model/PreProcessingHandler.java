...
public class PreProcessingHandler {
    ...
    //private File qualityFile = new File("P:\\My Documents\\Quality.txt");
    ...
    public final void createQualityFileWriter()
    {
        try
        {
            ...
            System.out.println("QualityFile:"+ qualityWriter.toString() + " "+
                    qualityFile.getName());
        }
        catch (IOException e)
        {
    ...
    public final void doTagFile()
    {
        ...
        String filename = "tag";
        try {
            FileWriter f0 = new FileWriter("D:\\" + filename + ".tag", false);
    ...
    public final void setQualityFile(File path)
    {
        qualityFile = path;
    }
