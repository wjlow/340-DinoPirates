...
public class CSVWriter
{
     ...
     */
    public CSVWriter(Writer writer, char sep)
    {
        this(writer, sep, DEFAULT_QUOTE_CHARACTER);
    }
     ...
     */
    public CSVWriter(Writer writer, char sep, char quote)
    {
        this(writer, sep, quote, DEFAULT_ESCAPE_CHARACTER);
    }
    ...
    {
        this(writer, sep, quote, escape, DEFAULT_LINE_END);
    }
     ...
     */
    public CSVWriter(Writer writer, char sep,
            char quote, String end)
    {
        this(writer, sep, quote, DEFAULT_ESCAPE_CHARACTER, end);
    }
     ...
     *               the line feed terminator to use
     */
    public CSVWriter(Writer writer, char sep, char quote, char escape,
            String end)
    {
    ...
    protected void writeColumnNames(final ResultSetMetaData metadata)
        throws SQLException {
            ...
            throws SQLException, IOException
    {
        ...
        while (rs.next())
        {
            ...
            for (int i = 0; i < columnCount; i++)
            {
                nextLine[i] = getColumnValue(
                        rs, metadata.getColumnType(i + 1), i + 1);
            }
    ...
    private static String getColumnValue(
            ResultSet rs, int colType, int colIndex)
            throws SQLException, IOException
    {
